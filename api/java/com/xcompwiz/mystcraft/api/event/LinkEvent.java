...
public abstract class LinkEvent extends Event {
	...
	/**
	 * Called once everything is finalized. The entity is fully realized in the world and has been updated on clients.
	 */
	public static class LinkEventEnd extends LinkEvent {
		public LinkEventEnd(World origin, World destination, Entity entity, ILinkInfo info) {
			super(origin, destination, entity, info);
		}
	}
}
