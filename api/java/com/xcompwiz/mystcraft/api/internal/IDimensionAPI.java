...
/**
 * Functions for interacting with Mystcraft dimensions. The implementation of this is provided by MystAPI. Do NOT
...
public interface IDimensionAPI {
	...
	/**
	 * Creates a new dimension as a Mystcraft Age. Mystcraft will handle tracking of the age for start up and
	 * communicate the id to the client for you. Note that this will only work server side.
	 * 
